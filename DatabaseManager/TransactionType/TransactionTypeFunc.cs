...
{
    public static class TransactionTypeFunc
    {
        ...
        )
        {
            try
            {
                ...
                var result = await client
                    ...
                    .Insert(
                        dbTransactionType,
                        new Supabase.Postgrest.QueryOptions { Returning = ReturnType.Representation }
                    );
        ...
        public static async Task<bool> DeleteTransactionType(long id, Client client)
        {
            try
            {
                await TransactionTypeFunc.RemoveTransactionTypeReferences(id, client);
